...
// #define WS2812_T0H_NS (0.35)
// #define WS2812_T0L_NS (0.7)
// #define WS2812_T1H_NS (0.8)
// #define WS2812_T1L_NS (0.6)
// #define WS2812_RESET_US (50)

const float ratio = (float)FREQ_INPUT / LED_STRIP_RMT_CLK_DIV / 1e09f;
...
// IRAM_ATTR rmt_item32_t cs8812_high = {
// 	.duration0 = DEFAULT_PULSE_LENGTH * DEFAULT_ONE_PULSE_LENGTH, /*0.01s * 35 = 350ms*/
// 	.level0 = 1,
